...
import com.aliyun.aksls.chlde.log.http.utils.ExceptionFactory;
import com.aliyun.aksls.chlde.log.http.utils.HttpHeaders;
import com.aliyun.aksls.chlde.log.http.utils.HttpUtil;
import com.aliyun.aksls.chlde.log.http.utils.IOUtils;
...
public class DefaultServiceClient extends ServiceClient {
    protected static HttpRequestFactory
    ...
    @Override
    public ResponseMessage sendRequestCore(Request request, String charset) throws IOException, LogException {
